...
Command: npx gltfjsx@6.5.0 mixtral.glb 
*/

import React, { useEffect } from "react";
import { useGLTF, useAnimations } from "@react-three/drei";

export default function Mixtral(props) {
  const group = React.useRef();
  const { nodes, materials, animations } = useGLTF("/model/mixtral.glb");
...
useGLTF.preload("/model/mixtral.glb");
