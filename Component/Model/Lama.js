...
Command: npx gltfjsx@6.5.0 botNew.glb 
*/

import React, { useEffect } from "react";
import { useGLTF, useAnimations } from "@react-three/drei";

export default function Lama(props) {
  const group = React.useRef();
  const { nodes, materials, animations } = useGLTF("/model/lama.glb");
...
useGLTF.preload("/model/lama.glb");
