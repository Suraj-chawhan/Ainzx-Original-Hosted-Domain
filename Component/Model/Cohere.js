...
Command: npx gltfjsx@6.5.0 cloudy.glb 
*/

import React, { useEffect } from "react";
import { useGLTF, useAnimations } from "@react-three/drei";

export default function Cohere(props) {
  const group = React.useRef();
  const { nodes, materials, animations } = useGLTF("/model/cloudy.glb");
...
useGLTF.preload("/model/cloudy.glb");
